...
import { useState } from 'react'
import logo1 from './fotot/logo1.png'
import javascript1 from './fotot/javascript1.png'
import './App.css'
      ...
      <section className="hero-container">
        <div className="glass-panel">
          <div className="text-side">
            <span className="badge">Front-End Duo</span>
            <h1>We turn designs into <span className="gradient-text">fluid reality.</span></h1>
            
            <div className="duo-stats">
              <div className="stat-item"><strong>2</strong> Developers</div>
              <div className="stat-item"><strong>100%</strong> Javascript</div>
            </div>
          </div>
          
          <div className="logo-side">
             <img src={logo1} alt="Logo" className="floating-logo"/>
          </div>
        </div>
      </section>
